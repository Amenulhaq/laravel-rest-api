...
use RestAPI\Middleware\ApiMiddleware;
...
class ApiRouter extends Router
{
    ...
    {
        if ($this->container && $this->container->bound('RestAPI\Routing\ApiResourceRegistrar')) {
            $registrar = $this->container->make('RestAPI\Routing\ApiResourceRegistrar');
        }
        else {
    ...
    public function addRoute($methods, $uri, $action)
    {
        ...
        foreach ($versions as $version) {
            ...
            // Options route
            $route = $this->createRoute(['OPTIONS'], $uri, ['uses' => '\RestAPI\Routing\ApiRouter@returnRoute']);
